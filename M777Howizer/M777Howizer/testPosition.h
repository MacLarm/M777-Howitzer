...
private:
   ...
   {  // setup
      ...
      // verify
      assertEquals(pos.getMetersX() , 11.2); // 11.1 + 0.5 * 0.2 * 1^2
      assertEquals(pos.getMetersY() , 22.35); // 22.2 + 0.5 * 0.3 * 1^2
   ...
   {  // setup
      ...
      // exercise
      pos.add(acc, vel, time); // Time = 2 seconds

      // verify
      assertEquals(pos.getMetersX() , 11.5); // 11.1 + 0.5 * 0.2 * 2^2
      assertEquals(pos.getMetersY() , 22.8); // 22.2 + 0.5 * 0.3 * 2^2
      assertEquals(acc.ddx, 0.2);
      assertEquals(acc.ddy, 0.3);
      assertEquals(vel.dx,  0.0);
      assertEquals(vel.dy,  0.0);
